// How many types of data types are there in JS? There are 7 primitive data types and 3 non-primitive data types in JavaScript. The primitive data types are: string, number, boolean, undefined, null, symbol, and BigInt. The non-primitive data types are: object, array, and function. 
...
// What is BigInt? BigInt is a primitive data type that can represent integers with arbitrary precision. It is used to store large integers that cannot be represented by the Number data type. It is created by appending 'n' to the end of an integer literal or by calling the BigInt() constructor.
...
// Primitives data types are call by value. It means that when we assign a primitive value to a variable, the variable stores the actual value of the primitive data types. When we assign a primitive value to another variable, the new variable gets a copy of the value, and any changes made to the new variable do not affect the orginal variable.
